...
async function fetchMe() {
  try {
    ...
    const res = await fetch('https://turing-web.onrender.com/api/me', {
      method: 'GET',
      headers: {
...
async function logout() {
  ...
  await fetch('https://turing-web.onrender.com/auth/logout', {
    method: 'POST',
    headers: {
      'Authorization': `Bearer ${token}`
    },
...
async function sendMessage() {
    ...
    try {
        ...
        const response = await fetch('https://turing-web.onrender.com/api/chat', {
            method: 'POST',
            headers: {
...
async function loadNews(source = 'tech') {
    ...
    try {
        ...
        const response = await fetch(`https://turing-web.onrender.com/api/news?source=${source}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
            }
...
async function loadWeather(location = 'New Delhi') {
    ...
    try {
        ...
        const response = await fetch(`https://turing-web.onrender.com/api/weather?location=${encodeURIComponent(location)}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
            }
